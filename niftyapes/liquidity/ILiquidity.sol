...
interface ILiquidity is ILiquidityAdmin, ILiquidityEvents {
    ...
    function supplyErc20(address asset, uint256 amount)
        external
        returns (uint256);
    ...
    /// @param amount The number of tokens to supply
    function supplyCErc20(address cAsset, uint256 amount)
        external
        returns (uint256);
    ...
    /// @param cAsset The address of the compound ERC20 token
    /// @param amount The number of tokens to withdraw
    function withdrawCErc20(address cAsset, uint256 amount)
        external
        returns (uint256);
    ...
    function assetAmountToCAssetAmount(address asset, uint256 amount)
        external
        returns (uint256);
    ...
    /// @param cAsset The compound token address
    /// @param amount The amount of asset to convert to cAsset
    function cAssetAmountToAssetAmount(address cAsset, uint256 amount)
        external
        returns (uint256);
}
